...
export default function UsersManagement() {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost/backend/allfeedback.php")
      .then((data) => data.json())
      .then((data) => {
        // alert("Fatch call..");
        // console.log("s2222222222222",data[0].result);
        setallfeedback(data[0].result);

       
        
        console.log("allfeedback  -- 11111111111",allfeedback);
      });
  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Recieved Feedback</h1>
...
{allfeedback.length ? (
              ...
              <td>{allfeedbacks.rating}</td>
              <td>{allfeedbacks.feedback}</td>
              {/* <td>{allfeedbacks.datetimetext}</td> */}
              <td>{allfeedbacks.usernamefeedback}</td>
